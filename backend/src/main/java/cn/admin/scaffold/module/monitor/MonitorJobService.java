...
import cn.admin.scaffold.module.monitor.dto.JobQuery;
import cn.admin.scaffold.module.monitor.dto.JobSaveRequest;
import cn.admin.scaffold.module.monitor.entity.SysJobDO;
import cn.admin.scaffold.module.monitor.entity.SysJobLogDO;
import cn.admin.scaffold.module.monitor.job.JobInvokeUtil;
import cn.admin.scaffold.module.monitor.job.SysJobSchedulerService;
...
import cn.admin.scaffold.module.monitor.vo.JobLogVo;
import cn.admin.scaffold.module.monitor.vo.SchedulerStatusVo;
...
public class MonitorJobService {
    ...
    private SysJobDO toEntity(JobSaveRequest request) {
        ...
        job.setConcurrent(request.getConcurrent() == null ? Integer.valueOf(DEFAULT_CONCURRENT) : request.getConcurrent());
        job.setStatus(request.getStatus() == null ? Integer.valueOf(DEFAULT_STATUS) : request.getStatus());
