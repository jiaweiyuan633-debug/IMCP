...
import cn.admin.scaffold.module.system.mapper.SysNoticeMapper;
import cn.admin.scaffold.module.system.mapper.SysNoticeReadMapper;
...
public class SystemNoticeService {
    ...
    public Long create(SysNoticeDO notice) {
        ...
        // 目标租户取发布线程 TenantContext（权威来源），不信任前端传的 tenantId；
