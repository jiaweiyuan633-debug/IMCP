...
import cn.admin.scaffold.module.system.entity.SysProcessDefDO;
import cn.admin.scaffold.module.system.entity.SysProcessNodeDO;
import cn.admin.scaffold.module.system.mapper.SysProcessDefMapper;
...
public class WarmFlowLegacyMigrator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        for (SysProcessDefDO def : legacyDefs) {
            Long tenantId = def.getTenantId() == null ? Long.valueOf(1L) : def.getTenantId();
