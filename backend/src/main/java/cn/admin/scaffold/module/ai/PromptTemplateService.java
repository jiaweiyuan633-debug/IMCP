...
import cn.admin.scaffold.module.ai.entity.AiPromptTemplateDO;
import cn.admin.scaffold.module.ai.mapper.AiPromptTemplateMapper;
...
public class PromptTemplateService {
    ...
    private AiPromptTemplateDO toEntity(PromptSaveRequest request) {
        ...
        template.setSort(request.getSort() == null ? Integer.valueOf(0) : request.getSort());
