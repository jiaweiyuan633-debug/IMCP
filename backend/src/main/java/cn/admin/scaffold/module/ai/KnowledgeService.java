...
import cn.admin.scaffold.module.ai.entity.AiKnowledgeBaseDO;
import cn.admin.scaffold.module.ai.entity.AiKnowledgeDocDO;
import cn.admin.scaffold.module.ai.mapper.AiKnowledgeBaseMapper;
...
public class KnowledgeService {
    ...
    public Long createBase(KnowledgeBaseSaveRequest request) {
        ...
        base.setStatus(request.getStatus() == null ? Integer.valueOf(ENABLED) : request.getStatus());
    ...
    private AiKnowledgeDocDO toDocEntity(KnowledgeDocSaveRequest request) {
        ...
        doc.setChunkIndex(0);
        doc.setStatus(request.getStatus() == null ? Integer.valueOf(ENABLED) : request.getStatus());
        return doc;
    }
