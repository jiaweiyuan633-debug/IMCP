...
public class SystemMessageService {
    ...
    public Long send(Long senderId, String messageType, String title, String content,
        ...
        if (receiverIds == null || receiverIds.isEmpty()) {
            return sendBroadcast(senderId, messageType, title, content, bizType, bizId);
        }
        ...
        for (Long receiverId : distinctIds) {
            Long id = insert(senderId, receiverId, messageType, title, content, bizType, bizId);
            if (firstId == null) {
                firstId = id;
            }
    ...
    private Map<String, Object> pushPayload(Long id, String messageType, String title,
        ...
        payload.put("bizId", bizId == null ? 0L : bizId);
